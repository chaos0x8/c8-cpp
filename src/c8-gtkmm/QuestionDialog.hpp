...
namespace C8::Gtkmm {
  ...
  public:
    QuestionDialog(Gtk::Window& parent, const std::string& question, const AnswerType& defaultValue)
      : Gtk::Dialog("Question dialog", parent), question(question) {
    ...
    static AnswerType exec(Gtk::Window& parent, const std::string& question, const AnswerType& defaultValue) {
      std::unique_ptr<QuestionDialog<AnswerType>> dialog(
        new QuestionDialog<AnswerType>(parent, question, defaultValue));
  ...
  public:
    static Gtk::ResponseType exec(
      Gtk::Window& parent, const std::string& question, Gtk::ButtonsType buttons = Gtk::BUTTONS_YES_NO);
  };
} // namespace C8::Gtkmm
